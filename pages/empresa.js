					...
					>
						<div>
							...
							<p style={{ fontSize: 15, marginBottom: 35 }}>
								...
								<br></br>
								Criando soluções bem-sucedidas desde 2020, nos tornamos
								referência em tecnologia e inovação, com mais de{' '}
								<strong>20 aplicativos</strong> construídos para empresas de
								diferentes portes e segmentos, desde startups até grandes
								players do mercado.
								<br></br>
								<br></br>
								Nosso foco é a Experiência do Usuário e nossa política de
								qualidade garante expertise técnica, eficiência dos produtos
								desenvolvidos e comprometimento com o atendimento das
							...
							<ul class='mb-0' style={{ fontSize: 15 }}>
								<li>
									...
									necessário apenas a aproximação física entre eles;
								</li>
								<li>
									<b>Fintech</b>: Startups que utilizam tecnologia de ponta para
									inovar na prestação de serviços de transações financeiras,
									como: saques, depósitos, cash-back, resgate, vouchers, entre
									outras operações;
								</li>
								<li>
									<b>Mapas e Geo-Localização</b>
								</li>
								<li>
									<b>Indústrias da produção e transformação;</b>
								</li>
								<li>
									<b>E-commerce;</b>
								</li>
							...
							<p style={{ fontSize: 15, marginTop: 20 }}>
								...
								<br></br>
								<br></br>
								Seja um projeto B2C ou B2B, MVP startup ou solução corporativa
								personalizada, iniciamos o projeto conhecendo o cliente,
								entendendo seu negócio, seu produto, os problemas que pretende
								resolver e as necessidades do usuário final.<br></br>
								<br></br>
								Nossos especialistas desenvolvem aplicativos móveis para iOS e
								Android, além de sistemas web, e estão comprometidos com a
								segurança, sigilo e garantia de qualidade, suporte e manutenção
								da aplicação.
							</p>
						</div>
					</div>
