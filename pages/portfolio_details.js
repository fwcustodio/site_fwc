...
const PortfolioDetails = () => {
    ...
    useEffect(async () => {
      ...
      async function helper() {
        ...
        axios.get('https://run.mocky.io/v3/f0d32df7-648f-483c-b648-6c9c45350451?id=' + project_id).then(async res => {
      ...
      <>
        ...
        {project != false ? (
          ...
          <main>
                   ...
                   <div className="container" >
                      <div className="row align-items-center text-center">
                         <div className="col-lg-6">
                            ...
                            <p className="page-header-text mb-5">{project.description}</p>
                            <div className="mb-10">
                               {project.appstore ? (<a className="mr-3" target="_blank" href={project.appstore_url}>
                               <img style={{height: '40px'}} src="/static/appstore_badge.svg"/>
                               </a>) : ''}
                               {project.playstore ? (<a target="_blank" href={project.playstore_url}>
                               <img style={{height: '40px'}} src="/static/playstore_badge.svg"/>
                               </a> ) : ''}  
                                  
                            </div>
                            <div style={{paddingTop: '25px',}} className="text-center">
                              <a href="#post"><button className="button-secondary">Saiba mais</button></a>
                            </div>
                         </div>
                         ...
                         <div className="col-lg-6 z-1 pt-5">
                            ...
                            <button className="button-secondary" style={{marginRight: '-80px'}} onClick={() => {
                              if(current_image - 1 < 0) {
                                setCurrentImage(project.carousel_images.length - 1);
                              } else 
                                setCurrentImage(current_image - 1);
                            }}>
                              <FontAwesomeIcon icon={faArrowLeft}/>
                            </button>
                            <IPhoneX width={320} height={640} screenshot={project.carousel_images[current_image]}>
                             
                            </IPhoneX>
                                     
                            <button className="button-secondary" style={{marginLeft: '-80px'}} onClick={() => {
                              if(current_image + 1 >= project.carousel_images.length) {
                                setCurrentImage(0);
                              } else 
                                setCurrentImage(current_image + 1);
                            }}>
             ...
             <svg  xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1440 320"><path fill="#940405" fill-opacity="1" d="M0,224L34.3,208C68.6,192,137,160,206,144C274.3,128,343,128,411,133.3C480,139,549,149,617,149.3C685.7,149,754,139,823,122.7C891.4,107,960,85,1029,69.3C1097.1,53,1166,43,1234,64C1302.9,85,1371,139,1406,165.3L1440,192L1440,0L1405.7,0C1371.4,0,1303,0,1234,0C1165.7,0,1097,0,1029,0C960,0,891,0,823,0C754.3,0,686,0,617,0C548.6,0,480,0,411,0C342.9,0,274,0,206,0C137.1,0,69,0,34,0L0,0Z"></path></svg>
             <div className="sep-mobile"/>
             <section id="post" style={{marginTop: '15vh'}}>
               <div className="width-80-vw text-center mb-5">
                 <div className="row justify-content-center">
                   <div className="col-lg-8">
                     ...
                     <br/>
                     <br/>
                     <p style={{textAlign: 'justify'}}>{project.post_content}</p>
                     <hr></hr>
                     <a href="/portfolio">
