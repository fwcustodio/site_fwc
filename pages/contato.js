							...
							<div className='container py-5'>
								<div className='row justify-content-center'>
									<div>
										...
										<div className='width-80-vw text-center mb-10'>
											<span className='h1 font-weight-bolder'>Contato</span>
											<p
												className='lead'
												style={{
													fontSize: 17,
											...
											>
												Sua ideia já está estruturada? Faltam alguns pontos para
												definir? Quer saber mais sobre o mundo mobile? Entre em
												contato conosco!
											</p>
										</div>
									</div>
								...
								<div className='row width-80-vw '>
									<div class='col-lg-4 text-center mb-5 mb-lg-0'>
										...
										<a
											href='https://is.gd/jyAyfr'
											target='_blank'
											className='color-primary custom-link'
										>
											<FontAwesomeIcon icon={faPhone} /> +55 (48) 99145-2528
										</a>
										<br />
										<a
											className='color-primary custom-link'
											...
											target='_blank'
										>
											<FontAwesomeIcon icon={faMapMarker} /> Ver no mapa
										</a>
									</div>
								</div>
							</div>
